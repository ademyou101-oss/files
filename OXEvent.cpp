	...
	switch (flag)
	{
		...
		case 1:
			if (info->answer == true)
			{
				...
				SendNoticeOxMap("#end", OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("정답은"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("O 입니다"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("OX_15SNSONRAAT"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("다음 문제 준비해주세요."), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap("#start", OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap("#send", OXEVENT_MAP_INDEX, true);
			}
			else
			{
				...
				SendNoticeOxMap("#end", OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("정답은"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("X 입니다"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("OX_15SNSONRAAT"), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap(LC_TEXT("다음 문제 준비해주세요."), OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap("#start", OXEVENT_MAP_INDEX, true);
				SendNoticeOxMap("#send", OXEVENT_MAP_INDEX, true);
...
#ifdef ENABLE_OX_RENEWAL
	SendNoticeOxMap(LC_TEXT("문제 입니다."), OXEVENT_MAP_INDEX, true);
	SendNoticeOxMap(m_vec_quiz[level][idx].Quiz, OXEVENT_MAP_INDEX, true);
	SendNoticeOxMap(LC_TEXT("맞으면 O, 틀리면 X로 이동해주세요"), OXEVENT_MAP_INDEX, true);
	SendNoticeOxMap(LC_TEXT("OX_20SNSONRA"), OXEVENT_MAP_INDEX, true);
	SendNoticeOxMap("#start", OXEVENT_MAP_INDEX, true);
	SendNoticeOxMap("#send", OXEVENT_MAP_INDEX, true);
#else
